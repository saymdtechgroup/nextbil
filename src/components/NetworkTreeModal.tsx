...
export const NetworkTreeModal: React.FC<NetworkTreeModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
      <div key={node.id} className="relative">
        <div className="flex items-center gap-2 mb-2 relative z-10">
          ...
          {level > 0 && (
            <div className="absolute -left-5 top-1/2 w-4 border-t-2 border-cyan-500/30 -translate-y-1/2" />
          )}
          ...
          <div 
            ...
            className={`flex-1 p-3 rounded-xl border flex items-center justify-between transition-all ${
              ...
              isMatch ? 'bg-amber-950/80 border-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.2)]' : 'bg-[#081426] border-cyan-500/20'
            }`}
          >
            <div className="flex items-center gap-3">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 border ${
                level === 0 ? 'bg-amber-500/20 border-amber-400/50 text-amber-300' : 
                node.rank !== 'Member' ? 'bg-cyan-500/20 border-cyan-400/50 text-cyan-300' : 'bg-cyan-900/50 border-cyan-500/30 text-cyan-300'
              }`}>
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <span className="text-[10px] text-cyan-300/70 block">Team Size</span>
              ...
              {hasChildren && (
                <div className="w-6 h-6 rounded-lg bg-cyan-900/40 flex items-center justify-center text-cyan-300">
        ...
        {hasChildren && node.isExpanded && (
          <div className="relative ml-5 pl-5 border-l-2 border-cyan-500/30 pt-1 pb-1">
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl bg-[#050b16] border border-amber-500/40 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
        
        {/* Header */}
        <div className="p-4 border-b border-cyan-500/20 flex items-center justify-between bg-[#081426]">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-cyan-300/70 font-mono-crypto">
        ...
        {/* Tools (Search) */}
        <div className="px-4 py-3 border-b border-cyan-500/15 bg-[#081426]">
          <div className="relative">
            <input 
              ...
              className="w-full bg-[#050b16] border border-cyan-500/30 rounded-xl py-2 pl-9 pr-4 text-xs text-slate-200 focus:outline-none focus:border-amber-400 font-mono-crypto"
            />
