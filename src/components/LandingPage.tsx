...
export const LandingPage: React.FC<LandingPageProps> = ({ onLaunch }) => {
  ...
  return (
    <div className="nxbc-landing min-h-screen bg-[#06010f] text-slate-200 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
      {/* Dynamic Background */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-cyan-600/10 rounded-full blur-[150px] mix-blend-screen animate-blob animation-delay-2000" />
        <div className="absolute top-[20%] left-[40%] w-[40vw] h-[40vw] bg-cyan-700/10 rounded-full blur-[100px] mix-blend-screen animate-blob animation-delay-4000" />
      </div>
      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-24 pb-32 max-w-7xl mx-auto flex flex-col items-center text-center">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <span className="px-4 py-1.5 rounded-full bg-cyan-950/50 border border-cyan-500/30 text-cyan-300 text-xs font-bold font-mono-crypto tracking-widest uppercase mb-6 inline-flex items-center gap-2">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight text-white font-rajdhani leading-tight mb-8">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-cyan-500 to-amber-400">
                Decentralized Finance
              </span>
            </h1>

            <p className="max-w-2xl mx-auto text-lg md:text-xl text-cyan-200/80 mb-10 leading-relaxed font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-24">
            {[
              ...
              <div key={i} className={`p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md text-left transition-all duration-1000 delay-${(i+1)*200} transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500/20 to-cyan-500/20 flex items-center justify-center mb-4 border border-white/5">
                ...
                <p className="text-xs text-cyan-300/60">{metric.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="vision" className="py-24 bg-black/40 border-y border-white/5">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-16">
              ...
              <p className="text-cyan-300/70 max-w-2xl mx-auto">Our revolutionary smart contract architecture eliminates counterparty risk.</p>
            </div>
              ...
              <div className="space-y-8">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-cyan-200/70 text-sm leading-relaxed">Unlike traditional presales that hold your tokens, NXBC mints your purchase directly to your Trust Wallet or MetaMask the second the transaction confirms.</p>
                  </div>
                </div>
                
                <div className="flex gap-4 items-start">
                  <div className="p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 mt-1">
                    <Server className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Virtual FIFO Registration</h3>
                    <p className="text-cyan-200/70 text-sm leading-relaxed">Plan your multi-phase exit strategy by allocating tokens in our virtual queue. Your tokens never leave your wallet until the sale actually happens.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-cyan-200/70 text-sm leading-relaxed">When your target phase completes, claim your USDT earnings with a single click. The smart contract safely swaps your held NXBC for the equivalent USDT atomically.</p>
                  </div>
                </div>
              </div>

              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-cyan-500/20 blur-3xl" />
                <div className="relative rounded-3xl border border-white/10 bg-[#0a0415] p-8 shadow-2xl overflow-hidden">
                  ...
                  <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
                    ...
                    <span className="text-[10px] font-mono-crypto text-cyan-400">NXBC_ENGINE.sol</span>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="h-12 rounded-xl bg-white/5 border border-white/5 flex items-center justify-between px-4">
                      <span className="text-xs text-cyan-300 font-mono-crypto">function buyTokens()</span>
                      <span className="text-[10px] bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded">MINT</span>
                    </div>
                    <div className="h-12 rounded-xl bg-white/5 border border-white/5 flex items-center justify-between px-4">
                      <span className="text-xs text-cyan-300 font-mono-crypto">function setVirtualAllocation()</span>
                      <span className="text-[10px] bg-amber-500/20 text-amber-400 px-2 py-1 rounded">QUEUE</span>
                    </div>
                    <div className="h-12 rounded-xl bg-gradient-to-r from-amber-500/10 to-cyan-500/10 border border-amber-500/30 flex items-center justify-between px-4">
                      <span className="text-xs text-amber-300 font-mono-crypto">function atomicWithdraw()</span>
                      <span className="text-[10px] bg-cyan-500/20 text-cyan-400 px-2 py-1 rounded">SWAP</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {[
                ...
                <div key={i} className={`relative p-6 rounded-2xl border ${i === 0 ? 'bg-amber-500/10 border-amber-500/50' : 'bg-[#0a0415] border-cyan-500/20'}`}>
                  ...
                  <h4 className="text-cyan-400 text-xs font-bold uppercase tracking-widest mb-2">Phase {p.phase}</h4>
                  <p className="text-2xl font-black text-white font-mono-crypto mb-1">{p.price}</p>
                  <p className="text-[10px] text-cyan-300/50 uppercase">{p.supply} NXBC</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 border-t border-white/5 bg-gradient-to-b from-transparent to-[#0a0415]">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <button
              onClick={onLaunch}
              className="px-8 py-4 rounded-xl bg-gradient-to-r from-amber-500 to-cyan-600 text-slate-900 font-black text-lg tracking-widest uppercase transition-all shadow-[0_0_30px_rgba(245,158,11,0.2)] flex items-center justify-center gap-3 mx-auto hover:scale-105"
            >
              Enter Dashboard
