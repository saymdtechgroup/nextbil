...
3. The remaining 80% is the Contract Pool share.
4. Seller order matching is server-side and uses `priority`, then `createdAt`, then `id`; the user-facing permanent FIFO number is stored separately..
